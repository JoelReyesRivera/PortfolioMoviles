...
import com.rockbass2560.rickandmortyapp.views.ActivityEpisodio
...
class CharacterAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is CharacterViewHolder) {
            ...
            holder.itemView.textView7.setOnClickListener{
                var intent = Intent(it.context,ActivityEpisodio::class.java)
                intent.putExtra("episodeName",holder.itemView.txtId.text.toString())
